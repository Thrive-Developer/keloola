...
export const operations = {
    getAll: {
        name: 'Get Many',
        value: 'getAll',
        action: 'Get many sales quotes',
        description: 'Get all sales quotes',
    },
    create: {
        name: 'Create',
        value: 'create',
        action: 'Create a sales quote',
        description: 'Create a new sales quote',
    },
    get: {
        name: 'Get',
        value: 'get',
        action: 'Get a sales quote',
        description: 'Get a sales quote by ID',
    },
    update: {
        name: 'Update',
        value: 'update',
        action: 'Update a sales quote',
        description: 'Update a sales quote',
    },
    delete: {
        name: 'Delete',
        value: 'delete',
        action: 'Delete a sales quote',
        description: 'Delete a sales quote',
    },
    send: {
        name: 'Send',
        value: 'send',
        action: 'Send sales quote',
        description: 'Send sales quote via email',
    },
    print: {
        name: 'Print',
        value: 'print',
        action: 'Print sales quote',
        description: 'Print sales quote',
    },
};

const showOnlyForSalesQuote = {
    resource: [resources.salesQuote.value],
};

export const salesQuoteNode: INodeProperties[] = [
    ...
    // ----------------------------------
    {
        ...
        description: 'The ID of the sales quote',
    },
    // ----------------------------------
    //         create, update
    // ----------------------------------
