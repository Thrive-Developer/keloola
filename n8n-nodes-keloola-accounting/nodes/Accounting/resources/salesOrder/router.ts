...
export async function router(
    ...
    switch (operation) {
        case operations.getAll.value: {
            url = `${ENV.ACCOUNTING_BASE_URL}/sale-order`;
            method = 'GET';
        ...
        case operations.get.value:
            url = `${ENV.ACCOUNTING_BASE_URL}/sale-order/${executeFunctions.getNodeParameter('id', 0)}`;
            method = 'GET';
            break;

        case operations.delete.value:
            url = `${ENV.ACCOUNTING_BASE_URL}/sale-order/delete/${executeFunctions.getNodeParameter('id', 0)}`;
            method = 'DELETE';
            break;

        case operations.approve.value:
            url = `${ENV.ACCOUNTING_BASE_URL}/sale-order/approve/${executeFunctions.getNodeParameter('id', 0)}`;
            method = 'POST';
            break;

        case operations.reject.value:
            url = `${ENV.ACCOUNTING_BASE_URL}/sale-order/reject/${executeFunctions.getNodeParameter('id', 0)}`;
            method = 'POST';
            break;

        case operations.fulfill.value:
            url = `${ENV.ACCOUNTING_BASE_URL}/sale-order/fulfill/${executeFunctions.getNodeParameter('id', 0)}`;
            method = 'POST';
            break;

        case operations.send.value: {
            url = `${ENV.ACCOUNTING_BASE_URL}/sale-order/send/${executeFunctions.getNodeParameter('id', 0)}`;
            method = 'POST';
        ...
        case operations.print.value: {
            url = `${ENV.ACCOUNTING_BASE_URL}/sale-order/print/${executeFunctions.getNodeParameter('id', 0)}`;
            method = 'POST';
            body = {
        ...
        case operations.update.value: {
            ...
            url =
                operation === operations.create.value
                    ? `${ENV.ACCOUNTING_BASE_URL}/sale-order`
                    : `${ENV.ACCOUNTING_BASE_URL}/sale-order/${id}`;
