  ...
  switch (operation) {
    case operations.getAll.value: {
      ...
      const response = await this.helpers.httpRequest({
        method: 'GET',
        url: `${this.getNode().parameters.accountingBaseUrl || '={{$parameter["requestDefaults"]["baseURL"]}}'}/sale-return`,
        qs,
        json: true,
      });
    ...
    case operations.get.value: {
      ...
      const response = await this.helpers.httpRequest({
        method: 'GET',
        url: `${this.getNode().parameters.accountingBaseUrl || '={{$parameter["requestDefaults"]["baseURL"]}}'}/sale-return/${id}`,
        json: true,
      });
      responseData = response.data || response;
      break;
    ...
    case operations.delete.value: {
      ...
      const response = await this.helpers.httpRequest({
        method: 'DELETE',
        url: `${this.getNode().parameters.accountingBaseUrl || '={{$parameter["requestDefaults"]["baseURL"]}}'}/sale-return/delete/${id}`,
        json: true,
      });
      responseData = response.data || response;
      break;
    ...
    case operations.print.value: {
      ...
      const response = await this.helpers.httpRequest({
        method: 'POST',
        url: `${this.getNode().parameters.accountingBaseUrl || '={{$parameter["requestDefaults"]["baseURL"]}}'}/sale-return/print/${id}`,
        body,
        json: true,
      });
      responseData = response.data || response;
    ...
    case operations.send.value: {
      ...
      const response = await this.helpers.httpRequest({
        method: 'POST',
        url: `${this.getNode().parameters.accountingBaseUrl || '={{$parameter["requestDefaults"]["baseURL"]}}'}/sale-return/send/${id}`,
        body,
        json: true,
      });
      responseData = response.data || response;
