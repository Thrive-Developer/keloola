...
export async function router(
  ...
  switch (operation) {
    ...
    case operations.get.value:
      url = `${ENV.ACCOUNTING_BASE_URL}/banks/income/${executeFunctions.getNodeParameter('id', 0)}`;
      method = 'GET';
      break;
