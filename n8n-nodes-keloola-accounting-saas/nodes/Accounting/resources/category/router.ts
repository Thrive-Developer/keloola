...
export async function router(
  ...
  switch (operation) {
    case operations.getAll.value:
      url = `${ENV.ACCOUNTING_BASE_URL}/accounting-setup/product-category`;
      method = 'GET';
      break;
    ...
    case operations.create.value:
      ...
      body = {
        ...
        color: executeFunctions.getNodeParameter('color', 0) as string,
      };
      break;

    case operations.get.value:
      url = `${ENV.ACCOUNTING_BASE_URL}/accounting-setup/product-category/${executeFunctions.getNodeParameter('id', 0)}`;
      method = 'GET';
      break;
    ...
    case operations.delete.value:
      url = `${ENV.ACCOUNTING_BASE_URL}/accounting-setup/product-category/delete/${executeFunctions.getNodeParameter('id', 0)}`;
      method = 'DELETE';
      break;
